...
import BlobCursorHero from './components/BlobCursorHero';


const Hero: React.FC = () => {
  const [showBlobDemo, setShowBlobDemo] = useState(false);

  return (
    <div className="flex flex-col gap-6 animate-fade-in">
      {/* Interactive Blob Cursor Demo Section */}
      <div className="relative -mx-4 sm:-mx-8 mb-8">
        <div className="relative w-full h-[400px] sm:h-[500px] overflow-hidden rounded-lg border-2 border-zinc-800 dark:border-zinc-700">
          <BlobCursorHero />
        </div>
        <p className="font-mono text-[9px] text-center uppercase mt-2 transition-colors duration-300 text-zinc-500 border-zinc-300 dark:text-zinc-600 dark:border-zinc-800">
          Fig A. Interactive Blob Cursor Reveal
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-8 items-start">
        ...
        <div className="w-full sm:w-48 shrink-0 flex flex-col gap-4">
          <div className="relative border p-1 border-zinc-400 bg-white dark:border-zinc-800 dark:bg-zinc-900/50">
            <img
