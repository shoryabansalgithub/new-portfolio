...
const ComponentsPreview: React.FC<ComponentsPreviewProps> = ({ onNavigate }) => {
  return (
    <div className="-mx-6 sm:-mx-8">
      {/* Header Section */}
      <h2 className="font-serif font-bold text-2xl mb-[24.5px] border-b pb-2 px-6 sm:px-8 transition-colors duration-300 text-zinc-900 border-zinc-300 dark:text-zinc-100 dark:border-zinc-800">
