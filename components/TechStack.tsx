...
const TechStack: React.FC = () => {
  return (
    <section className="animate-fade-in" style={{ animationDelay: '0.3s' }}>
      <h3 className="font-serif font-bold text-2xl mb-6 border-b pb-2 px-6 transition-colors duration-300 text-zinc-900 border-zinc-300 dark:text-zinc-100 dark:border-zinc-800">Tools & Tech</h3>
