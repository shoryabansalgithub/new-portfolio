...
export const TypescriptLogo = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 128 128" className={className}>
    ...
    <path d="M72.3 90.4c-2.3 1.3-5.3 2.1-8.5 2.1-10.9 0-16.1-5.6-16.1-16.4V52h14v22.7c0 4.1 1.1 6.8 5.4 6.8 2.3 0 4.2-.6 5.3-1.4V90.4zM96 92.5c-3.1 0-5.8-.8-8.6-2.2l3-9c2 1 4 1.7 6.1 1.7 2.8 0 4.2-1.1 4.2-3.2 0-2-2.1-2.9-6.4-4.5-6.5-2.5-9.6-6-9.6-11.4 0-8.2 6.6-12.7 15.3-12.7 3.5 0 6.6.9 9.1 2.1l-2.8 9.3c-2.1-.9-4.2-1.5-6.1-1.5-2.6 0-3.9 1.1-3.9 2.7 0 1.9 2.3 2.8 6.5 4.3 6.8 2.5 9.4 6.3 9.4 11.5 0 8.7-6.5 12.9-16.2 12.9z" fill="white"/>
  </svg>
);
...
export const NextLogo = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 180 180" className={className} fill="none">
    ...
    <g mask="url(#mask0_1_2)">
      <circle cx="90" cy="90" r="90" fill="white" stroke="white" strokeWidth="4"/> 
