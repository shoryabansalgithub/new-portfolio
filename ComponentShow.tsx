...
const ComponentShow: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="md:hidden min-h-screen flex flex-col items-center justify-center bg-paper dark:bg-paper-dark text-center px-6">
      ...
      <div className="hidden md:flex min-h-screen flex-row">
        ...
        {/* Sidebar */}
        <aside className="w-full md:w-64 border-b-2 md:border-b-0 md:border-r-2 border-zinc-800 bg-paper dark:bg-paper-dark flex-shrink-0">
          <div className="p-6 md:sticky md:top-0">
            <div className="mb-6 md:mb-8 flex justify-between items-center md:block">
              <div>
                <h1 className="text-xl md:text-2xl font-serif font-bold tracking-tight uppercase text-zinc-900 dark:text-zinc-100">
                  Component Library
                </h1>
            ...
            <nav className="flex overflow-x-auto md:overflow-visible md:block gap-6 md:gap-0 pb-2 md:pb-0 -mx-6 px-6 md:mx-0 md:px-0">
              ...
              {Array.from(new Set(components.map(c => c.category))).map(category => (
                <div key={category} className="mb-0 md:mb-6 min-w-[200px] md:min-w-0">
                  <h3 className="text-xs font-mono uppercase tracking-wider text-zinc-500 mb-2 px-2 hidden md:block">
                    {category}
                  </h3>
                      ...
                      .map(component => (
                        <li key={component.id}>
                          <button
                            ...
                            className={`w-full text-left px-3 py-2 rounded-md text-sm transition-colors whitespace-nowrap md:whitespace-normal ${selectedComponent === component.id
            ...
            <div className="mt-8 pt-6 border-t border-zinc-300 dark:border-zinc-700 hidden md:block">
        ...
        <main className="flex-1 bg-paper dark:bg-paper-dark min-w-0">
          <div className="p-4 sm:p-8 md:p-12">
            {/* Header */}
            <div className="mb-8 md:mb-12 pb-6 border-b-2 border-zinc-800">
            ...
            {/* Component Preview */}
            <div className={`rounded-lg border-2 border-zinc-300 dark:border-zinc-700 min-h-[400px] md:min-h-[500px] flex items-center justify-center overflow-hidden relative ${(selectedComponent === 'cassette-player' || selectedComponent === 'receipt-printer' || selectedComponent === 'laptop') ? '' : 'bg-white dark:bg-zinc-900 p-4 sm:p-8 md:p-12'
              }`}>
              <div
